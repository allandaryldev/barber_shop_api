...
import { custom_ext, required, required_if, email, min, max, alpha, alpha_num, alpha_dash, alpha_spaces, digits, numeric, decimal, sameAs, confirmed,min_value,is_not } from 'vee-validate/dist/rules'
...
extend('min_value', {
    ...min_value,
    params: ['length'],
    message: '{_field_} minimum value is 1.'
})
